...
public class PositionTargetWeightingDtoMappingExtensionTests
{
    // Test the MapToPositionTargetWeightingDto method
    [Fact]
    ...
    // Test the MapToPositionTargetWeightingDto method with null position target weighting model
    [Fact]
    ...
    // Test the MapToPositionTargetWeightingDtos method
    [Fact]
    ...
    // Test the MapToPositionTargetWeightingDtos method with null position target weighting model list
    [Fact]
    ...
    // Test the MapToPositionTargetWeightingDtos method with empty position target weighting model list
    [Fact]
